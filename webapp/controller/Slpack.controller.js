...
sap.ui.define([
	...
	return BaseController.extend("com.shunyu.slpack.controller.Slpack", {
		...
		_onRouteMatched: function (oEvent) {
			...
			sQM22Filters.push(new Filter("Zmatnr", FilterOperator.EQ, "100024522-999"));
		...
		_setFormData: function (packNum, packQuantity, printBatch) {
			...
			if (packNum && packNum != null && packQuantity && packQuantity != null) {
				var oTotal = parseInt(packNum) * parseInt(packQuantity);
		...
		_generateHU: function () {
			...
			MessageBox.success("生成HU成功！" + oKunnrModel.oData.results[ocustomerTable.getSelectedIndices()[0]].Zhzf);
